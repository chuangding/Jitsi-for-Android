...
import com.bu.meet.util.DownloadProfilePicAndRegisterUtil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Uri profilePic = profile.getProfilePictureUri(30, 30);
                user.setProfilePic(profilePic.toString());
                Bundle parameters = new Bundle();
                parameters.putString("fields", "email");
                request.setParameters(parameters);
                request.executeAsync();
                new DownloadProfilePicAndRegisterUtil(activity, BUMeetConstants.FACEBOOK).execute(user, user.getProfilePic());
            }
        ...
        if(user != null && user.getEmailID() != null){
            new DownloadProfilePicAndRegisterUtil(this, BUMeetConstants.FACEBOOK).execute(user, user.getProfilePic());
        }
    }
    ...
    public void onConnected(Bundle bundle) {
        ...
        if(mGoogleApiClient.isConnected()) {
           ...
           // Intent intent = new Intent(this,WelcomeActivity.class);
            ...
            intent.putExtra(BUMeetConstants.LOGIN_VIA,BUMeetConstants.GOOGLE);*/
            user.setFirstName(personName);
            user.setLastName(BUMeetConstants.EMPTY_STRING);
            user.setEmailID(currentPersonEmail);
            new DownloadProfilePicAndRegisterUtil(this,BUMeetConstants.GOOGLE).execute(user,personPhoto);
