...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras!=null && extras.getString(BUMeetConstants.LOGIN_VIA) != null && extras.getString(BUMeetConstants.LOGIN_VIA).equals(BUMeetConstants.GOOGLE)){
            currentUser.setEmailID(extras.getString(BUMeetConstants.EMAIL));
            currentUser.setFirstName(extras.getString(BUMeetConstants.DISPLAY_NAME));
            currentUser.setLastName(BUMeetConstants.EMPTY_STRING);
        }
